...
@Component({
  selector: 'app-following-block',
  templateUrl: './following-block.component.html',
  styleUrls: ['./following-block.component.scss']
})
export class FollowingBlockComponent implements OnInit {
  @Input() action = 'follow';
